      ...
      <>
        <ul className="flex flex-col lg:flex-row lg:items-center  lg:gap-12 text-base lg:text-lg font-medium">
          <li className="border-b pb-1 lg:border-none lg:pb-0">
            <a href="#" className={`text-brandBlack ${ !loaded ? 'text-black' : 'text-white hover:underline' }`}>
              Vendors
            </a>
          </li>
          <li className="border-b pb-1 lg:border-none lg:pb-0">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:gap-4">
            <li className="border-b pb-1 lg:border-none lg:pb-0">
              <a
                href="#"
                className={`text-brandBlack border lg:text-sm ${!loaded ? 'text-black' : 'text-white lg:text-sm border-white' } lg:px-6 lg:py-3 rounded-full` }
              >
                Login
              </a>
            </li>
