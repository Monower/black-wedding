    ...
    return (
      <>
        <footer className="bg-brandBlack">
          <div className="container mx-auto px-2 lg:px-24 py-6 lg:py-12 flex flex-col">
            <div className="text-white flex flex-col lg:flex-row justify-between lg:gap-28  pb-10">
              ...
              <ul className="flex flex-col lg:w-[16%] pb-5 lg:pb-0">
                <li className="text-base lg:text-xl font-bold pb-0 lg:pb-2">
                  The company
                </li>
                <li className="pb-1 lg:pb-4">
              ...
              <div className="pb-5 lg:pb-0">
                <h3 className="text-base lg:text-xl font-bold pb-2">
                  Are you a vendor?
                </h3>
                <p className="text-sm lg:text-lg font-medium">
                  Sign up today to reach more couples and book more weddings!
                </p>
              </div>
              <div>
                <h3 className="text-base lg:text-xl font-bold pb-2 text-center lg:text-left">
                  Stay in touch
                </h3>
